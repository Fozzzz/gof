...
<head>
    ...
    <script type="text/javascript">
        function changeAdd() {
            ...
            $("#list").append("<dl><dt><p>缴纳人姓名</p><input  type='text' id='name" + num + "' name='party[" +(num-1) + "].party_name' class='online_check'/></dt><dd><p>证件号码</p><input id='certificate" + sf + "' type='text'  name='party[" + (sf-1) + "].party_idcard' class='online_check link_input'/></dd></dl>");
        }
        function changeSub() {
        ...
        <div class="Lj-cen">
            ...
            <div class="w786">
                ...
                <div class="online">
                    ...
                    <div class="online_img"><img src="../../../assets/front/images/icon_08_13.jpg" width="653"
                                                 height="385"/></div>
                </div>
              ...
              <span class="online_span"><i>数 量：</i><a onclick="changeSub()" href="javascript:"><img
                      src="../../../assets/front/images/icon_08_14.jpg"/></a>
              <input type="text" class="online_num" id="online" value="1"/><a onclick="changeAdd()"
                    ...
                    <form action="/gof/add.action" method="post">
                        ...
                        <div id="list">
                            ...
                            <dl>
                                <dt>
                                <p>缴纳人姓名</p><input id="name1" type='text' class='online_check'
                                                   name="party[0].party_name"/></dt>
                                <dd><p>证件号码</p><input id="certificate1" type='text' class='online_check link_input'
                                                      name="party[0].party_idcard"/></dd>
                            </dl>
                        </div>
