        ...
        <div class="Lj-cen">
            ...
            <div class="w786">
              ...
              <span class="online_span"><i>数 量：</i><a onclick="changeSub()" href="javascript:"><img
                      src="../images/icon_08_14.jpg"/></a>
              <input type="text" class="online_num" id="online" value="1"/><a onclick="changeAdd()"
                                                                              href="javascript:"><img
                          src="../images/icon_08_15.jpg"/></a></span>
                    <form action="/gof/add.do" >
                        <dl>
                            <dt>
                            <p>取票电话</p><input name="trade_tel" type="text" class="online_check"/></dt>
                        ...
                        <div id="list">
                            ...
                            <dl>
                                <dt>
                                <p>缴纳人姓名</p><input name="users[0].user_name" id="name1" type='text'
                                                   class='online_check'/></dt>
                                <dd><p>证件号码</p><input name="users[0].user_idcard" id="certificate1" type='text'
                                                      class='online_check link_input'/></dd>
                            </dl>
                        </div>
