...
<form action="/gof/putShop2.do" method="post">
    <div class="row">
        <div class="col-md-12">
            <div class="portlet box black ">
                <div class="portlet-body form">
                    ...
                    <div class="form-body">
                        ...
                        <input type="text" class="form-control" name="shop_address" value="${shop.shop_address}">
                        <label class="control-label" >电话</label>
                        <input type="text" class="form-control" name="shop_tel" value="${shop.shop_tel}">
                        <label class="control-label" >简介</label>
                        <input type="text" class="form-control" name="shop_content"value="${shop.shop_content}"  >
