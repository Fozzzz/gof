    ...
    <div class="col-md-12">
        <div class="portlet box black ">
            <div class="portlet-body form">
                <form>
                    <div class="form-body">
                        <input type="hidden" name="ware_id" >
                        <label class="control-label">名称</label>
                        <input type="text" class="form-control" name="ware_name">
                        <label class="control-label">类型</label>
                        <select class="form-control" id="select_typeid" name="ware_typeid">
                            <option selected value="1">住宿</option>
                        ...
                        <input type="text" class="form-control" name="ware_price">
                        ...
                        <input type="text" class="form-control" name="ware_bed" >
                        <label class="control-label">早餐</label>
                        <input type="text" class="form-control" name="ware_breakfast" >
                        <label class="control-label">wifi</label>
                        <input type="text" class="form-control" name="ware_wifi" >
                        <label class="control-label">礼品</label>
                        <input type="text" class="form-control" name="ware_gift" >
                    </div>
                </form>
            </div>
        </div>
