...
public class Goods {
    ...
    public Goods(Integer goods_id, String goods_name, double goods_price, String goods_address, String goods_phone, String goods_total, Integer goods_typeid) {
    ...
    public Goods(Integer goods_id, String goods_name, double goods_price, String goods_address, String goods_phone, String goods_total, Integer goods_typeid, String bed, String breakfast, String wifi, String gift) {
        this.goods_id = goods_id;
        this.goods_name = goods_name;
        this.goods_price = goods_price;
        this.goods_address = goods_address;
