...
public interface WareDao {
    ...
    @Update("update ware set ware_name=#{ware_name},ware_price=#{ware_price},shop_id=#{shop_id},ware_typeid=#{ware_typeid},ware_bed=#{ware_bed},ware_breakfast=#{ware_breakfast},ware_wifi=#{ware_wifi},ware_gift=#{ware_gift} where ware_id=#{ware_id}")
    int put(Ware ware);
